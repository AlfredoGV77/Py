...
ventana.title('Productos con precio mayor a 1000, dimensiones de 200 y Zoom tele de 33')
...
def datos_excel():
	...
	try:
		...
		df=pd.read_excel("camaras2.xlsx",sheet_name="csv_camaras_2.csv",header=0, usecols=[1,6,7])
	...
	for fila in df_fila:
            if(fila[0]<33 and fila[1]<200 and fila[2]>1000):
