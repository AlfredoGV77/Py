...
def datos_excel():
	...
	try:
		...
		df=pd.read_excel("camaras2.xlsx",sheet_name="csv_camaras_2.csv",header=0, usecols=[0,7,6])
	...
	for fila in df_fila:
		#Lo que hace es buscar los datos que empiecen por una S
            palabra_inicial=fila[0].startswith('Olympus')
		
            if(palabra_inicial==True and fila[2]<249 and fila[1]>101):
